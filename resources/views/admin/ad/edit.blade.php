        ...
        <form class="layui-form">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="L_img" name="img" required="" lay-verify="img" autocomplete="off" class="layui-input" value="{{ $ad->img }}">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="L_link" name="link" required="" lay-verify="link" autocomplete="off" class="layui-input" value="{{ $ad->link }}">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="L_user_id" name="user_id" required="" lay-verify="user_id"
                           autocomplete="off" class="layui-input" value="{{ $ad->user_id }}">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="L_sort" name="sort" required="" lay-verify="sort"
                           autocomplete="off" class="layui-input" value="{{ $ad->sort }}">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="checkbox" name="status"  lay-text="显示|关闭"  @if($ad->status == 0) checked @endif lay-skin="switch">
    ...
    <script>
        layui.use(['form','layer'], function(){
            ...
            form.on('submit(add)', function(data){
                ...
                $.post('/fileStore/ad/edit',data.field)
                    .done(function (e) {

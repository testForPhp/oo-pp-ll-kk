            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="L_title" name="title" required="" lay-verify="title"
                           autocomplete="off" class="layui-input" value="{{ $sort->title }}">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="L_code" name="code" required="" lay-verify="code"
                           autocomplete="off" class="layui-input" value="{{ $sort->code }}">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="L_sort" name="sorting" required="" lay-verify="sorting"
                           autocomplete="off" class="layui-input" value="{{ $sort->sorting }}">
                </div>
            </div>
            <div class="layui-form-item">
                <label for="L_sort" class="layui-form-label">
                ...
                <div class="layui-input-inline">
                    <input type="checkbox" name="type"  lay-text="推荐|关闭" @if($sort->type == 1)checked @endif lay-skin="switch">
    ...
    <script>
        layui.use(['form','layer'], function(){
            ...
            form.on('submit(add)', function(data){
                ...
                $.post('/fileStore/sort/edit',data.field)
                    .done(function (e) {
